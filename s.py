...
platform5 = PlatformSprite(g, PhotoImage(file="platform3.gif"), 175, 350, 66, 10)
platform6 = PlatformSprite(g, PhotoImage(file="platform3.gif"), 50, 300, 66, 10)
platform7 = PlatformSprite(g, PhotoImage(file="platform3.gif"), 170, 120, 66, 10)
platform8 = PlatformSprite(g, PhotoImage(file="platform3.gif"), 45, 60, 66, 10)
